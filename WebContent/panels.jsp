...
<style>
.font{font-size:25px;}
.font1{font-size:35px;background-color:#00FFFF;border-bottom:3px solid #000}
.font2{font-size:25px;border-bottom:2px solid #000;border-left:2px solid #000}
</style>
  <meta charset="utf-8">
...
<body style="background:url(img/grzy.jpg);background-repeat:no-repeat ;background-size:100% 100%; background-attachment: fixed;">
  <%	
	...
	Map<String,String> map=user.getall(name);
	...
	String registtime=map.get("time");
...
%>
  ...
  <input type="file" name="fileToUpload" id="fileToUpload" Onchange="fileSelected()" style="display:none;">
    ...
    <section id="main-content">
      ...
      <br/><br/><br/><br/>
      	<table border="0px" align="center" height="400px" width="400px" class="font">
      	<tr>
      			<td align="center" class="font1" style="color:white">个人</td>
      			<td align="center" class="font1" style="color:white">信息&nbsp;&nbsp;</td>
      		</tr>
      		<tr>
      			<td align="center" class="font2" style="color:black">姓名:</td>
      			<td align="center"><%=map.get("username")%></td>
      		</tr>
      		<tr>
      			<td align="center" class="font2" style="color:black">绑定电话:</td>
      			<td align="center"><%=map.get("tel") %></td>
      		</tr>
      		<tr>
      			<td align="center" class="font2" style="color:black">性别:</td>
      			<td align="center"><%=sex %></td>
      		</tr>
      		<tr>
      			<td align="center" class="font2" style="color:black">注册时间:</td>
      			<td align="center"><%=registtime %></td>
      		</tr>
      		<tr>
      			<td align="center" class="font2" style="color:black">城市:</td>
