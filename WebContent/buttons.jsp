...
<style>
.font{font-size:25px}
.font1{font-size:20px;border-bottom:2px solid #000}
</style>
  <meta charset="utf-8">
...
<body style="background:url(img/bgbg.jpg);background-repeat:no-repeat ;background-size:100% 100%; background-attachment: fixed;">
<%	
	...
	List<Map<String,String>> list=hotel.getuser(name);
%>
  ...
  <input type="file" name="fileToUpload" id="fileToUpload" Onchange="fileSelected()" style="display:none;">
    ...
    <h2 style="margin-left:600px;color:black">您的宾馆预订信息</h2>
    <!-- /MAIN CONTENT -->
    <table border="3px" width="600px" height="300px" class="font" style="margin-left:420px;margin-top:30px">
    	<tr>
    		<td align="center" style="color:black;background:#696969">宾馆名</td>
    		<td align="center" style="color:black;background:#696969">价格</td>
    		<td align="center" style="color:black;background:#696969">地址</td>
    	</tr>
<c:forEach items="${userList}" var="i">
<tr>
<td style="background:white;opacity:0.6;color:black">${i.hotelname }</td>
<td style="background:white;opacity:0.6;color:black">${i.price }</td>
<td style="background:white;opacity:0.6;color:black">${i.address}</td>
</tr>
</c:forEach>
</table>
<br/>
<table width="600px" height="30px"  style="margin-left:420px;margin-top:0px">
	<tr>
		<td align="right">
				<a href="HotelPagingServlet?requestPage=${pager.firstPage}"  style="color:black;background:white;opacity:0.6" class="font1">首页</a>
				<a href="HotelPagingServlet?requestPage=${pager.previosPage}"  style="color:black;background:white;opacity:0.6" class="font1">上一页</a>
				<a href="HotelPagingServlet?requestPage=${pager.nextPage}"  style="color:black;background:white;opacity:0.6" class="font1">下一页</a>
				<a href="HotelPagingServlet?requestPage=${pager.lastPage}"  style="color:black;background:white;opacity:0.6" class="font1">尾页</a>
				</br>
				<font style="background:black;color:white">
				每页显示${pager.pageSize}条记录总页数 ${pager.totalPage}记录总数 ${pager.totalCount}	
				</font>	
		</td>
		</tr>
    </table>
