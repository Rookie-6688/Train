...
%>
  ...
  <input type="file" name="fileToUpload" id="fileToUpload" Onchange="fileSelected()" style="display:none;">
    ...
    <!-- /MAIN CONTENT -->
    <form action="choice" method="post" style="margin-top:20px">
      <table border="1px" height="350px" width="600px" class="font" style="background-color:#FFE4C4;background:#C0C0C0;opacity:0.6;margin-left:450px">
      	<tr height="50px">
      		<td colspan="2" align="center" style="background-color:#696969;opacity:1"><font style="color:red" size="3" class="font1">查询</font></td>
      	</tr>
      	<tr>
      		<td colspan="2" align="center" style="color:black">出行方式:<select name="go">
      	...
      	<tr>
      		<td align="center" style="color:black">起始站:<select name="first" id="first">
      					<option value="北京">北京</option>
      					<option value="上海">上海</option>
      					<option value="成都">武汉</option>
      					<option value="合肥">合肥</option>
      					<option value="成都">成都</option>
      					<option value="南京">南京</option>
      				</select></td>
      		<td align="center" style="color:black">终点站:<select name="end" id="end">
      					<option value="北京">北京</option>
      					<option value="上海">上海</option>
      	...
      	<tr>
      		<td align="center" style="color:black">出发日期:</td>
      		<td align="center"><input type="date" value="2019-09-30" name="date"/></td>
      	</tr>
      	<tr>
      		<td colspan="2" align="center"><input type="submit" style="color:black" value="查询"/></td>
      	</tr>
      </table>
      </form>
      <br/><br/>
