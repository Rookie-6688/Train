...
%>
  ...
  <input type="file" name="fileToUpload" id="fileToUpload" Onchange="fileSelected()" style="display:none;">
    ...
    <font style="margin-left:500px;background:white;margin-top:20px" color="red" size="5px">该班次没有列车,请选择其他班次</font>
    <br/><br/>
    <div><img src="img/gpsb.jpg" width="200px" height="150px" style="margin-left:620px"></div>
    <br/><br/>
    <button onclick="location.href='javascript:history.go(-1);'" style="margin-left:660px">返回查询界面</button>	
