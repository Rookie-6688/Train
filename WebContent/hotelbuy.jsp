...
<%	
	...
	Map<String,String> map=hotel.getone(Integer.parseInt(id));
	String hotelname=map.get("name");
	...
	if(Integer.parseInt(map.get("number"))<=0){
		...
		boolean i=hotel.deone(Integer.parseInt(id));
		boolean m=hotel.addhotel(name, Integer.parseInt(id), hotelname, price, address);
		if(i&&m){
			s="购买成功";
		}else{
			s="购买失败";
...
%>
  ...
  <input type="file" name="fileToUpload" id="fileToUpload" Onchange="fileSelected()" style="display:none;">
    ...
    <!-- /MAIN CONTENT -->
    <br/><br/><br/>
    <font style="margin-left:640px;background:black" color="white" size="5px"><%=s %></font><br/><br/>
    <div style="margin-left:600px">
    <img src="img/cxkdq.jpg">
    </div>
    <br/><br/>
	<button onclick="aa()" style="margin-left:660px">返回首页</button>	
