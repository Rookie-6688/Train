...
<%
	...
	Map<String, String> map=ticket.getticketback(tid);
...
/* 	<option value="1">北京</option>
		...
		if(gotype.equals("火车")){
			type=0;
		}else if(gotype.equals("大巴")){
			type=1;
		}else if(gotype.equals("飞机")){
			type=2;
		}
%>
  ...
  <input type="file" name="fileToUpload" id="fileToUpload" Onchange="fileSelected()" style="display:none;">
    ...
    <!-- /MAIN CONTENT -->
    <h2 align="center">购票成功!</h2>
    <div align="center">
    <img src="img/cxkdq.jpg">
    </div>
    <br></br>
     <h2 align="center">车票详细内容如下</h2>
   	<table border="1px" width="600px" height="300px" style="background:url(img/hcp.jpg);background-repeat:no-repeat ;background-size:100% 100%; background-attachment: fixed;margin-left:350px">
		...
		<tr>
			...
			<td align="center"><%=train_station %>车<%=seat %>座</td>
		</tr>
		<tr>
  ...
  <script type="text/javascript">
    ...
    function bb(){
    	window.location.href="detailshotel.jsp?type=<%=type%>&city=<%=city%>";
    }
</script>
</body>
