...
%>
  ...
  <input type="file" name="fileToUpload" id="fileToUpload" Onchange="fileSelected()" style="display:none;">
    ...
    <div><img src="img/gpsb.jpg" width="200px" height="150px" style="margin-left:600px"></div>
    <br/>
    <font style="margin-left:500px;background:white" color="red" size="5px">该宾馆无空余房间,请选择其他宾馆</font>
    <br/><br/>
    <button onclick="location.href='javascript:history.go(-1);'" style="margin-left:650px">返回宾馆界面</button>	
