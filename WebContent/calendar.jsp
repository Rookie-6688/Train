...
/* 	List<List<Integer>> ll=ticket.getlist(list, first, end); */
  ...
  <input type="file" name="fileToUpload" id="fileToUpload" Onchange="fileSelected()" style="display:none;">
    ...
    <section id="main-content">
      <section class="wrapper">
      	<table border="1px" width="700px" height="500px" align="center" margin-left:500px>
      	<tr align="center">
      	...
      	<tr align="center">
      		<td width="100px" style="background-color:white;opacity:0.7"><a href="details.jsp?i=<%=train.getname(list.get(i))%>"><b><%=train.getname(list.get(i))%></b><br/>
      			<b>硬座票:<%=1200-ll.get(i).get(0)%></b><br/>
      			<b>软卧票:<%=160-ll.get(i).get(1)%></b><br/>
      			<b>站票:<%=600-ll.get(i).get(2)%></b><br/>
      		</a></td>
      		<%for(int m=0;m<map.get(train.getname(list.get(i))).size();m++){ %>
	      		...
	      		<%if(map.get(train.getname(list.get(i))).get(m).equals(first)||map.get(train.getname(list.get(i))).get(m).equals(end)) {%>
	      			<td style="background-color:white;opacity:0.7"><div style="color:red"><b><%=map.get(train.getname(list.get(i))).get(m) %></b></div><div style="color:red"><b>出发时间:<%=train_l.get(train.getname(list.get(i))).get(m)%></b></div></td>
	      		<%}else{ %>	
	      			<td style="background-color:white;opacity:0.7"><div><b><%=map.get(train.getname(list.get(i))).get(m) %></b></div><div><b>出发时间:<%=train_l.get(train.getname(list.get(i))).get(m) %></b></div></td>
	      		<%} %>
	      		
      		<%} %>
	      		<td width="100px" style="background-color:white;opacity:0.7">
	      		<b>硬座票价:<%=numberstation.get(train.getname(list.get(i)))*16%><a href="details.jsp?i=<%=train.getname(list.get(i))%>&&type=1">购票</a></b>
	      		<b>软卧票价:<%=numberstation.get(train.getname(list.get(i)))*32%><a href="details.jsp?i=<%=train.getname(list.get(i))%>&&type=2">购票</a></b>
	      		<b>站票票价:<%=numberstation.get(train.getname(list.get(i)))*16%><a href="details.jsp?i=<%=train.getname(list.get(i))%>&&type=3">购票</a></b>
	      		</td>
      	</tr>
      	<%} %>
      	</table>
