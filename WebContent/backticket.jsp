...
<%
	...
	String time=ticket.gettime(id);
	
	long i=System.currentTimeMillis();
	DateFormat df=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	Date date=df.parse(time);
	long leave=date.getTime();
	
	String s="";
	if(leave-3600*1000*12>i){
		ticket.changetype(id);
		s="退票成功";
	}else{
		s="列车出发时间前12小时内不能退票";
	}
...
<div style="margin-left:430px">
	<font color="red" size="5px"><%=s %></font></div><br/><br/>
		<div style="margin-left:600px">
    <img src="img/tpcg.jpg" width="200" height="200">
    </div>
    <br>
	<button onclick="aa()" style="margin-left:650px">返回首页</button>	
