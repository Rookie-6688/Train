...
<%
	...
	if(end.equals("北京")){
		o=1;
	}else if(end.equals("上海")){
		o=4;
	}else if(end.equals("武汉")){
		o=7;
	}else if(end.equals("成都")){
		o=10;
	}else if(end.equals("合肥")){
		o=13;
	}else if(end.equals("南京")){
		o=16;
	}
%>
  ...
  <input type="file" name="fileToUpload" id="fileToUpload" Onchange="fileSelected()" style="display:none;">
    ...
    <!-- /MAIN CONTENT -->
    <font style="margin-left:590px;background:white;margin-top:20px" color="red" size="5px">购票成功</font>
    <div style="margin-left:550px">
    <img src="img/cxkdq.jpg">
    </div>
    <br></br>
     <font style="margin-left:550px;background:white;margin-top:20px" color="red" size="5px">车票详细内容如下</font>
   	<table border="1px" width="600px" height="300px" style="background:url(img/hcp.jpg);background-repeat:no-repeat ;background-size:100% 100%; background-attachment: fixed;margin-left:350px">
		<tr>
			<td colspan="2" align="center"><%=gotype %>票</td>
		</tr>
		<tr>
			<td align="center">列车号:</td>
			<td align="center"><%=trainid %></td>
		</tr>
		<tr>
			<td align="center">行程:</td>
			<td align="center"><%=first %>-----<%=end %></td>
		</tr>
		<tr>
			<td align="center">时间:</td>
			<td align="center"><font size="1px"><%=start_time %>------<%=end_time %></font></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="center"><%=train_station %>厢<%=seat %>座</td>
		</tr>
		<tr>
	...
	<br/>
		<button onclick="aa()" style="margin-left:500px">返回主页</button>
		<button onclick="bb()" style="margin-left:70px">看看附近宾馆</button>
	<br/><br/><br/><br/>
    <!-- /MAIN CONTENT -->
    <!--main content end-->
    <!--footer start-->
  ...
  <!--script for this page-->
	...
	function bb(){
	window.location.href="detailshotel.jsp?type=<%=Integer.parseInt(ticket_type)%>&city=<%=o %>";
}
    function fileSelect() {
